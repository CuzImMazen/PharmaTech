...
/// "Create cash box" setup card.
 bool get hasNoBox; bool get isInitialLoading; bool get isRefreshing;/// Transactions list + its pagination state.
 ...
 CashTransactionType? get txFilter;/// Creating the cash box (one-time setup).
...
@useResult
$Res call({
 CashBoxModel? cashBox, bool hasNoBox, bool isInitialLoading, bool isRefreshing, List<CashTransactionModel> transactions, int currentPage, int lastPage, bool hasMore, bool isLoadingMore, bool areTransactionsLoading, CashTransactionType? txFilter, bool isCreating, Failure? failure, CashBoxAction? lastAction
});
...
/// Create a copy of CashBoxState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? cashBox = freezed,Object? hasNoBox = null,Object? isInitialLoading = null,Object? isRefreshing = null,Object? transactions = null,Object? currentPage = null,Object? lastPage = null,Object? hasMore = null,Object? isLoadingMore = null,Object? areTransactionsLoading = null,Object? txFilter = freezed,Object? isCreating = null,Object? failure = freezed,Object? lastAction = freezed,}) {
...
as CashTransactionType?,isCreating: null == isCreating ? _self.isCreating : isCreating // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( CashBoxModel? cashBox,  bool hasNoBox,  bool isInitialLoading,  bool isRefreshing,  List<CashTransactionModel> transactions,  int currentPage,  int lastPage,  bool hasMore,  bool isLoadingMore,  bool areTransactionsLoading,  CashTransactionType? txFilter,  bool isCreating,  Failure? failure,  CashBoxAction? lastAction)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CashBoxState() when $default != null:
return $default(_that.cashBox,_that.hasNoBox,_that.isInitialLoading,_that.isRefreshing,_that.transactions,_that.currentPage,_that.lastPage,_that.hasMore,_that.isLoadingMore,_that.areTransactionsLoading,_that.txFilter,_that.isCreating,_that.failure,_that.lastAction);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( CashBoxModel? cashBox,  bool hasNoBox,  bool isInitialLoading,  bool isRefreshing,  List<CashTransactionModel> transactions,  int currentPage,  int lastPage,  bool hasMore,  bool isLoadingMore,  bool areTransactionsLoading,  CashTransactionType? txFilter,  bool isCreating,  Failure? failure,  CashBoxAction? lastAction)  $default,) {final _that = this;
switch (_that) {
case _CashBoxState():
return $default(_that.cashBox,_that.hasNoBox,_that.isInitialLoading,_that.isRefreshing,_that.transactions,_that.currentPage,_that.lastPage,_that.hasMore,_that.isLoadingMore,_that.areTransactionsLoading,_that.txFilter,_that.isCreating,_that.failure,_that.lastAction);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( CashBoxModel? cashBox,  bool hasNoBox,  bool isInitialLoading,  bool isRefreshing,  List<CashTransactionModel> transactions,  int currentPage,  int lastPage,  bool hasMore,  bool isLoadingMore,  bool areTransactionsLoading,  CashTransactionType? txFilter,  bool isCreating,  Failure? failure,  CashBoxAction? lastAction)?  $default,) {final _that = this;
switch (_that) {
case _CashBoxState() when $default != null:
return $default(_that.cashBox,_that.hasNoBox,_that.isInitialLoading,_that.isRefreshing,_that.transactions,_that.currentPage,_that.lastPage,_that.hasMore,_that.isLoadingMore,_that.areTransactionsLoading,_that.txFilter,_that.isCreating,_that.failure,_that.lastAction);case _:
  return null;
...
class _CashBoxState implements CashBoxState {
  const _CashBoxState({this.cashBox, this.hasNoBox = false, this.isInitialLoading = false, this.isRefreshing = false,  List<CashTransactionModel> transactions = const <CashTransactionModel>[], this.currentPage = 1, this.lastPage = 1, this.hasMore = true, this.isLoadingMore = false, this.areTransactionsLoading = false, this.txFilter, this.isCreating = false, this.failure, this.lastAction}): _transactions = transactions;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CashBoxState&&(identical(other.cashBox, cashBox) || other.cashBox == cashBox)&&(identical(other.hasNoBox, hasNoBox) || other.hasNoBox == hasNoBox)&&(identical(other.isInitialLoading, isInitialLoading) || other.isInitialLoading == isInitialLoading)&&(identical(other.isRefreshing, isRefreshing) || other.isRefreshing == isRefreshing)&&const DeepCollectionEquality().equals(other._transactions, _transactions)&&(identical(other.currentPage, currentPage) || other.currentPage == currentPage)&&(identical(other.lastPage, lastPage) || other.lastPage == lastPage)&&(identical(other.hasMore, hasMore) || other.hasMore == hasMore)&&(identical(other.isLoadingMore, isLoadingMore) || other.isLoadingMore == isLoadingMore)&&(identical(other.areTransactionsLoading, areTransactionsLoading) || other.areTransactionsLoading == areTransactionsLoading)&&(identical(other.txFilter, txFilter) || other.txFilter == txFilter)&&(identical(other.isCreating, isCreating) || other.isCreating == isCreating)&&(identical(other.failure, failure) || other.failure == failure)&&(identical(other.lastAction, lastAction) || other.lastAction == lastAction));
}


@override
int get hashCode => Object.hash(runtimeType,cashBox,hasNoBox,isInitialLoading,isRefreshing,const DeepCollectionEquality().hash(_transactions),currentPage,lastPage,hasMore,isLoadingMore,areTransactionsLoading,txFilter,isCreating,failure,lastAction);
