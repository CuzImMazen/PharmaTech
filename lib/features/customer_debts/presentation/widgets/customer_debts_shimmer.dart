...
/// Loading placeholder for the Customer Debts list. Mirrors
/// [CustomerDebtCard]'s layout (customer name + status pill + amounts box).
class CustomerDebtsShimmer extends StatelessWidget {
  const CustomerDebtsShimmer({super.key});
