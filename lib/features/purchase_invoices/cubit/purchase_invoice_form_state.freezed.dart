...
mixin _$PurchaseInvoiceFormState {
 ...
 List<SupplierModel> get suppliers; List<ProductCardModel> get products; bool get isOptionsLoading; bool get hasOptionsError; SupplierModel? get selectedSupplier; List<PurchaseInvoiceItemInput> get items; bool get isSaving; Failure? get failure; bool get saved;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(suppliers),const DeepCollectionEquality().hash(products),isOptionsLoading,hasOptionsError,selectedSupplier,const DeepCollectionEquality().hash(items),isSaving,failure,saved);

@override
String toString() {
  return 'PurchaseInvoiceFormState(suppliers: $suppliers, products: $products, isOptionsLoading: $isOptionsLoading, hasOptionsError: $hasOptionsError, selectedSupplier: $selectedSupplier, items: $items, isSaving: $isSaving, failure: $failure, saved: $saved)';
}
...
@useResult
$Res call({
 List<SupplierModel> suppliers, List<ProductCardModel> products, bool isOptionsLoading, bool hasOptionsError, SupplierModel? selectedSupplier, List<PurchaseInvoiceItemInput> items, bool isSaving, Failure? failure, bool saved
});
...
/// Create a copy of PurchaseInvoiceFormState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? suppliers = null,Object? products = null,Object? isOptionsLoading = null,Object? hasOptionsError = null,Object? selectedSupplier = freezed,Object? items = null,Object? isSaving = null,Object? failure = freezed,Object? saved = null,}) {
...
switch (_that) {
case _PurchaseInvoiceFormState() when $default != null:
return $default(_that.suppliers,_that.products,_that.isOptionsLoading,_that.hasOptionsError,_that.selectedSupplier,_that.items,_that.isSaving,_that.failure,_that.saved);case _:
  return orElse();
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_suppliers),const DeepCollectionEquality().hash(_products),isOptionsLoading,hasOptionsError,selectedSupplier,const DeepCollectionEquality().hash(_items),isSaving,failure,saved);
...
/// Create a copy of PurchaseInvoiceFormState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? suppliers = null,Object? products = null,Object? isOptionsLoading = null,Object? hasOptionsError = null,Object? selectedSupplier = freezed,Object? items = null,Object? isSaving = null,Object? failure = freezed,Object? saved = null,}) {
