...
mixin _$CustomerReturnInvoiceFormState {
 ...
 List<CustomerModel> get customers; List<ProductCardModel> get products; bool get isOptionsLoading; bool get hasOptionsError; CustomerModel? get selectedCustomer;/// Set when the return is seeded from a sales invoice — sent as
...
/// no restriction (standalone return). Used to filter the product dropdown.
 Set<int> get allowedProductIds; List<CustomerReturnItemInput> get items; bool get isSaving; Failure? get failure; bool get saved;/// True while a barcode lookup is in flight from the in-form scanner.
 bool get isScanning;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(customers),const DeepCollectionEquality().hash(products),isOptionsLoading,hasOptionsError,selectedCustomer,originalSalesInvoiceId,const DeepCollectionEquality().hash(allowedProductIds),const DeepCollectionEquality().hash(items),isSaving,failure,saved,isScanning);

@override
String toString() {
  return 'CustomerReturnInvoiceFormState(customers: $customers, products: $products, isOptionsLoading: $isOptionsLoading, hasOptionsError: $hasOptionsError, selectedCustomer: $selectedCustomer, originalSalesInvoiceId: $originalSalesInvoiceId, allowedProductIds: $allowedProductIds, items: $items, isSaving: $isSaving, failure: $failure, saved: $saved, isScanning: $isScanning)';
}
...
@useResult
$Res call({
 List<CustomerModel> customers, List<ProductCardModel> products, bool isOptionsLoading, bool hasOptionsError, CustomerModel? selectedCustomer, int? originalSalesInvoiceId, Set<int> allowedProductIds, List<CustomerReturnItemInput> items, bool isSaving, Failure? failure, bool saved, bool isScanning
});
...
/// Create a copy of CustomerReturnInvoiceFormState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? customers = null,Object? products = null,Object? isOptionsLoading = null,Object? hasOptionsError = null,Object? selectedCustomer = freezed,Object? originalSalesInvoiceId = freezed,Object? allowedProductIds = null,Object? items = null,Object? isSaving = null,Object? failure = freezed,Object? saved = null,Object? isScanning = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<CustomerModel> customers,  List<ProductCardModel> products,  bool isOptionsLoading,  bool hasOptionsError,  CustomerModel? selectedCustomer,  int? originalSalesInvoiceId,  Set<int> allowedProductIds,  List<CustomerReturnItemInput> items,  bool isSaving,  Failure? failure,  bool saved,  bool isScanning)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CustomerReturnInvoiceFormState() when $default != null:
return $default(_that.customers,_that.products,_that.isOptionsLoading,_that.hasOptionsError,_that.selectedCustomer,_that.originalSalesInvoiceId,_that.allowedProductIds,_that.items,_that.isSaving,_that.failure,_that.saved,_that.isScanning);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<CustomerModel> customers,  List<ProductCardModel> products,  bool isOptionsLoading,  bool hasOptionsError,  CustomerModel? selectedCustomer,  int? originalSalesInvoiceId,  Set<int> allowedProductIds,  List<CustomerReturnItemInput> items,  bool isSaving,  Failure? failure,  bool saved,  bool isScanning)  $default,) {final _that = this;
switch (_that) {
case _CustomerReturnInvoiceFormState():
return $default(_that.customers,_that.products,_that.isOptionsLoading,_that.hasOptionsError,_that.selectedCustomer,_that.originalSalesInvoiceId,_that.allowedProductIds,_that.items,_that.isSaving,_that.failure,_that.saved,_that.isScanning);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<CustomerModel> customers,  List<ProductCardModel> products,  bool isOptionsLoading,  bool hasOptionsError,  CustomerModel? selectedCustomer,  int? originalSalesInvoiceId,  Set<int> allowedProductIds,  List<CustomerReturnItemInput> items,  bool isSaving,  Failure? failure,  bool saved,  bool isScanning)?  $default,) {final _that = this;
switch (_that) {
case _CustomerReturnInvoiceFormState() when $default != null:
return $default(_that.customers,_that.products,_that.isOptionsLoading,_that.hasOptionsError,_that.selectedCustomer,_that.originalSalesInvoiceId,_that.allowedProductIds,_that.items,_that.isSaving,_that.failure,_that.saved,_that.isScanning);case _:
  return null;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_customers),const DeepCollectionEquality().hash(_products),isOptionsLoading,hasOptionsError,selectedCustomer,originalSalesInvoiceId,const DeepCollectionEquality().hash(_allowedProductIds),const DeepCollectionEquality().hash(_items),isSaving,failure,saved,isScanning);
...
mixin _$CustomerReturnItemInput {
 ...
 ProductCardModel? get product; String get quantity; String get unitPrice; String get tax; String get discount;
...
@override
int get hashCode => Object.hash(runtimeType,product,quantity,unitPrice,tax,discount);

@override
String toString() {
  return 'CustomerReturnItemInput(product: $product, quantity: $quantity, unitPrice: $unitPrice, tax: $tax, discount: $discount)';
}
...
@useResult
$Res call({
 ProductCardModel? product, String quantity, String unitPrice, String tax, String discount
});
...
/// Create a copy of CustomerReturnItemInput
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? product = freezed,Object? quantity = null,Object? unitPrice = null,Object? tax = null,Object? discount = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ProductCardModel? product,  String quantity,  String unitPrice,  String tax,  String discount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CustomerReturnItemInput() when $default != null:
return $default(_that.product,_that.quantity,_that.unitPrice,_that.tax,_that.discount);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ProductCardModel? product,  String quantity,  String unitPrice,  String tax,  String discount)  $default,) {final _that = this;
switch (_that) {
case _CustomerReturnItemInput():
return $default(_that.product,_that.quantity,_that.unitPrice,_that.tax,_that.discount);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ProductCardModel? product,  String quantity,  String unitPrice,  String tax,  String discount)?  $default,) {final _that = this;
switch (_that) {
case _CustomerReturnItemInput() when $default != null:
return $default(_that.product,_that.quantity,_that.unitPrice,_that.tax,_that.discount);case _:
  return null;
...
class _CustomerReturnItemInput implements CustomerReturnItemInput {
  const _CustomerReturnItemInput({this.product, this.quantity = '', this.unitPrice = '', this.tax = '', this.discount = ''});
...
/// Create a copy of CustomerReturnItemInput
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? product = freezed,Object? quantity = null,Object? unitPrice = null,Object? tax = null,Object? discount = null,}) {
