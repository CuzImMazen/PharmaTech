  ...
  Widget build(BuildContext context) {
    return BlocBuilder<DashboardCubit, DashboardState>(
      ...
      builder: (context, state) {
        ...
        final maxAmount = hasData
            ? points.map((d) => d.revenue).reduce((value, element) => math.max(value, element))
            : 1.0;
            ...
            child: Column(
              ...
              children: [
                ...
                if (hasData)
                  ...
                  _EmptyWeeklyRevenue(
                    onRetry: () => context.read<DashboardCubit>().refreshWeeklyRevenue(),
                  ),
                context.vMd,
                Row(
                  children: [
...
class _EmptyWeeklyRevenue extends StatelessWidget {
  const _EmptyWeeklyRevenue({required this.onRetry});
