...
/// Loading placeholder for the Customer Return Invoices list. Mirrors
/// [CustomerReturnInvoiceCard]'s layout (return number + date + customer +
/// refund total + status pill) inside the same bordered surfaceContainer.
class CustomerReturnInvoicesShimmer extends StatelessWidget {
  const CustomerReturnInvoicesShimmer({super.key});
