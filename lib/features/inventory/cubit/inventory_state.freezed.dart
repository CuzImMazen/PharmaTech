...
mixin _$InventoryState {
 ...
 List<ProductCardModel> get products; bool get isInitialLoading; bool get isLoadingMore; bool get isRefreshing; String get searchQuery; String? get sortBy; String? get stockStatus; List<int> get categoryIds; List<int> get companyIds; int? get baseUnitId; bool? get prescriptionRequired; List<String> get expiryFilters; num? get minPrice; num? get maxPrice; bool get inStockOnly; int get currentPage; int get lastPage; bool get hasMore; bool get isFilterOptionsLoading; bool get isLoadingCategories; bool get isLoadingUnits; bool get isLoadingCompanies; bool get hasCategoriesError; bool get hasUnitsError; bool get hasCompaniesError; List<ProductCategoryModel> get categories; List<BaseUnitModel> get units; List<CompanyModel> get companies; Failure? get failure;
...
@override
int get hashCode => Object.hashAll([runtimeType,const DeepCollectionEquality().hash(products),isInitialLoading,isLoadingMore,isRefreshing,searchQuery,sortBy,stockStatus,const DeepCollectionEquality().hash(categoryIds),const DeepCollectionEquality().hash(companyIds),baseUnitId,prescriptionRequired,const DeepCollectionEquality().hash(expiryFilters),minPrice,maxPrice,inStockOnly,currentPage,lastPage,hasMore,isFilterOptionsLoading,isLoadingCategories,isLoadingUnits,isLoadingCompanies,hasCategoriesError,hasUnitsError,hasCompaniesError,const DeepCollectionEquality().hash(categories),const DeepCollectionEquality().hash(units),const DeepCollectionEquality().hash(companies),failure]);

@override
String toString() {
  return 'InventoryState(products: $products, isInitialLoading: $isInitialLoading, isLoadingMore: $isLoadingMore, isRefreshing: $isRefreshing, searchQuery: $searchQuery, sortBy: $sortBy, stockStatus: $stockStatus, categoryIds: $categoryIds, companyIds: $companyIds, baseUnitId: $baseUnitId, prescriptionRequired: $prescriptionRequired, expiryFilters: $expiryFilters, minPrice: $minPrice, maxPrice: $maxPrice, inStockOnly: $inStockOnly, currentPage: $currentPage, lastPage: $lastPage, hasMore: $hasMore, isFilterOptionsLoading: $isFilterOptionsLoading, isLoadingCategories: $isLoadingCategories, isLoadingUnits: $isLoadingUnits, isLoadingCompanies: $isLoadingCompanies, hasCategoriesError: $hasCategoriesError, hasUnitsError: $hasUnitsError, hasCompaniesError: $hasCompaniesError, categories: $categories, units: $units, companies: $companies, failure: $failure)';
}
...
switch (_that) {
case _InventoryState() when $default != null:
return $default(_that.products,_that.isInitialLoading,_that.isLoadingMore,_that.isRefreshing,_that.searchQuery,_that.sortBy,_that.stockStatus,_that.categoryIds,_that.companyIds,_that.baseUnitId,_that.prescriptionRequired,_that.expiryFilters,_that.minPrice,_that.maxPrice,_that.inStockOnly,_that.currentPage,_that.lastPage,_that.hasMore,_that.isFilterOptionsLoading,_that.isLoadingCategories,_that.isLoadingUnits,_that.isLoadingCompanies,_that.hasCategoriesError,_that.hasUnitsError,_that.hasCompaniesError,_that.categories,_that.units,_that.companies,_that.failure);case _:
  return orElse();
